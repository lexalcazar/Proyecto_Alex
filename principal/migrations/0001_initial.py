# Generated by Django 5.2.12 on 2026-04-05 16:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('usuario', 'Usuario'), ('grupo', 'Grupo'), ('sala', 'Sala')], default='usuario', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='principal.grupo')),
            ],
        ),
        migrations.CreateModel(
            name='Evento',
            fields=[
                ...
                ('reserva', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='principal.reserva')),
            ],
        ),
        migrations.CreateModel(
            name='Sala',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('disponible', 'Disponible'), ('reservado', 'Reservado'), ('cerrado', 'Cerrado')], default='disponible', max_length=20)),
                ('sala', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='principal.sala')),
            ],
        ),
    ]
